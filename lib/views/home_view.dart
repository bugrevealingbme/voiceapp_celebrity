...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<HomeViewModel>(
      ...
      onPageBuilder: (context, viewModel, themeData) => Stack(
        children: [
          Scaffold(
                              ...
                              return Hero(
                                ...
                                child: Container(
                                  ...
                                  constraints: BoxConstraints(
                                      maxHeight: AppSizes.height15),
                                  child: GridView.builder(
                                    shrinkWrap: true,
                                    itemCount:
                                        viewModel.celebrities?.length ?? 0,
                                    padding: EdgeInsets.zero,
                                    primary: false,
                                    physics:
                                    ...
                                    itemBuilder: (context, index) {
                                      return Observer(builder: (_) {
                                        ...
                                        return InkWell(
                                          ...
                                          splashColor: Colors.transparent,
                                          onTap: () {
                                            viewModel.selectedId = viewModel
                                                    .celebrities?[index].id
                                                    .toString() ??
                                                '';
                                          },
                                          child: Column(
          ...
          Observer(builder: (context) {
            return Positioned(
              ...
              child: IgnorePointer(
                child: AnimatedContainer(
                  decoration: BoxDecoration(
                      color: viewModel.openMenu == false
                          ? Colors.transparent
                          : Colors.black54),
                  duration:
                      const Duration(milliseconds: AppValues.fastDuration),
                ),
              ),
            );
          }),
          Observer(builder: (_) {
            return AnimatedPositioned(
              ...
              left: viewModel.openMenu ? 15 : AppSizes.width100,
              right: viewModel.openMenu ? 15 : AppSizes.width100,
              top: ScreenUtil().statusBarHeight + 15,
              bottom: viewModel.openMenu
                                  ...
                                  Flexible(
                                    child: AnimatedContainer(
                                      ...
                                      child: ClipOval(
                                        child: Container(
                                          decoration: BoxDecoration(
                                            image: viewModel.celebrities?[index]
                                                            .img !=
                                                        null &&
                                                    viewModel
                                                            .celebrities?[index]
